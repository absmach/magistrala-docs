...
| --------------- | --------- | --------------------------------------------------------- | -------- |
| id              | string    | Unique identifier of the alarm                            | Auto     |
| rule_id         | string    | ID of the rule that triggered the alarm                   | Auto     |
| domain_id       | string    | ID of the domain this alarm belongs to                    | Auto-    |
| channel_id      | string    | ID of the channel related to the alarm                    | Auto     |
| client_id       | string    | ID of the client associated with the alarm                | Auto     |
...
Alarm is creation is handled by the rules engine. This is done by creating a rule whose output is an alarm. When r=the threshold condition defined by the rule is met, an alarm is automatically generated.
...
| order           | string | Specify the criteria tp order the results e.g `updated_by`                                            |
...
```bash
curl --location --request PUT 'http://localhost:8050/f93c0da3-d436-42a0-ac93-d2c96f80187a/alarms/721d7925-148c-4003-8fa0-e15af4493976' \
--header 'Content-Type: application/json' \
