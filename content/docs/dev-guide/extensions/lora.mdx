...
<Callout type="warn">
The LoRa adapter is a `magistrala-contrib` service and has been obsolete for a while (see the [magistrala-contrib overview](/dev-guide/extensions/magistrala-contrib)).
</Callout>
