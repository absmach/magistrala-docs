...
> **Note:** All API operations require appropriate role-based permissions. Refer to the [Roles Schema](/dev-guide/roles-schema#reports) for details on available roles and the permissions they grant.
