...
```bash
curl --location --request PUT 'http://localhost:9008/{workspaceID}/reports/configs/{reportID}/template' \
...
```bash
curl --location 'http://localhost:9008/{workspaceID}/reports/configs/{reportID}/template' \
--header 'Authorization: Bearer $ACCESSTOKEN'
```
...
```bash
curl --location --request DELETE 'http://localhost:9008/{workspaceID}/reports/configs/{reportID}/template' \
--header 'Authorization: Bearer $ACCESSTOKEN'
```
...
```bash
curl --location 'http://localhost:9008/{workspaceID}/reports/configs' \
--header 'Content-Type: application/json' \
--header 'Authorization: Bearer $ACCESSTOKEN' \
--data '{
...
```bash
curl --location 'http://localhost:9008/{workspaceID}/reports?action=download' \
--header 'Content-Type: application/json' \
--header 'Authorization: Bearer $ACCESSTOKEN' \
--data '{
    "name": "Temp Report",
...
Base URL: `http://localhost:9008/{workspaceID}/reports`
...
```bash
curl -X POST http://localhost:9008/{workspaceID}/reports \
--header 'Content-Type: application/json' \
--header 'Authorization: Bearer $ACCESSTOKEN' \
--data '{
    "name": "lab 1 report",
...
```bash
curl "http://localhost:9008/{workspaceID}/reports/configs?status=enabled&limit=10" \
--header 'Authorization: Bearer $ACCESSTOKEN'
```
...
```bash
curl --location 'http://localhost:9008/{workspaceID}/reports/configs/{reportID}' \
...
```bash
curl --location http://localhost:9008/{workspaceID}/reports/configs/{reportID}/enable \
--header 'Authorization: Bearer $ACCESSTOKEN'
```
...
```bash
curl --location http://localhost:9008/{workspaceID}/reports/configs/{reportID}/disable \
--header 'Authorization: Bearer $ACCESSTOKEN'
```
...
```bash
curl --location --request PATCH 'http://localhost:9008/{workspaceID}/reports/configs/{reportID}' \
--header 'Content-Type: application/json' \
--header 'Authorization: Bearer $ACCESSTOKEN' \
--data '{
