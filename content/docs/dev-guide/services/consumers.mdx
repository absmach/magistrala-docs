...
<Callout type="info" title="Writers are real; Notifiers are dead code">
  ...
  **Notifiers** section (SMTP/SMPP) is not: `consumers/notifiers/*` still exists as source but
  ...
  Magistrala still sends (workspace-invitation emails) is Atom, not this package.
</Callout>
...
```go
import "github.com/absmach/magistrala/consumers/writers/timescale"
...
```go
import "github.com/absmach/magistrala/consumers/writers/postgres"
