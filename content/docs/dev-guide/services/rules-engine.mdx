...
> **Note:** Access to each operation is governed by domain-level roles. Refer to the [Roles Schema](/dev-guide/roles-schema#rules) for details on which permissions are required.
