...
currently registered** on the root `magistrala-cli` command tree (which only exposes `health,
login, workspaces, channels, groups, authz, devices, gateways, devicetypes`). The commands below
