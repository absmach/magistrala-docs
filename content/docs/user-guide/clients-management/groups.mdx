...
Groups use the same generic-action model as workspaces, clients and channels, but with scopes that reflect the group hierarchy. The **Applies to** options are:
