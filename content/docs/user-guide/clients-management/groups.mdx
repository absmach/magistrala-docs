...
For detailed instructions on managing metadata, including working with interactive maps for location and perimeter data, see the [Metadata Management Guide](/docs/user-guide/metadata).
...
(See the [Clients](/docs/user-guide/clients-management/clients) section for a full overview of client functionality.)
...
(See the [Channels](/docs/user-guide/clients-management/channels) section for more details.)
