...
Clicking on the `···` button at the end of each row opens a modal displaying structured details about the selected operation, the same way it does for [Client](/user-guide/clients-management/clients#journals) and [Channel](/user-guide/clients-management/channels#journals) journals.
