...
Add a channel **name** and optionally a **Route**, **tags** and **metadata**. Like a domain's Route, the channel **Route** is a short, human-readable identifier for the channel.
