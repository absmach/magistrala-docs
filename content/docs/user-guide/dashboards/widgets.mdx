...
> Before adding widgets, devices must be connected and sending data. Refer to the [Quick Start Guide][users-quick-start] for setup instructions.
...
[users-quick-start]: /user-guide/users-quick-start
