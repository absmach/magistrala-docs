...
A **Workspace** is where you manage **Clients**, **Channels**, **Groups**, **Dashboards**, **Members**, **Rules** and **Bootstrap** services.
...
When you create a client within a specific group, it is automatically assigned to that group and can be connected to **any channel in the workspace**.
...
> More information about Rules Creation and Updating can be found in the [Rules Engine Section](/user-guide/rules-engine)
