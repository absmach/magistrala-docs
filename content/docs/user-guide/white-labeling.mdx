...
You can also reach it from **Platform Management → White Labeling**, alongside the **Workspaces** and [**Users**](/user-guide/platform-management/users) admin tabs (and **Plans** on Magistrala Cloud — see [Billing Plans](/user-guide/platform-management/plans)). Both paths lead to the same page, `/platform-management/white-labeling`; the user menu is just the faster route.
