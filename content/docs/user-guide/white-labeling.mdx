...
You can also reach it from **Platform Management → White Labeling**, alongside the [**Workspaces**](/user-guide/platform-management/workspaces) and [**Users**](/user-guide/platform-management/users) admin tabs. Both paths lead to the same page, `/platform-management/white-labeling`; the user menu is just the faster route.
