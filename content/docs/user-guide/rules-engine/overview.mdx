...
> As with clients, channels and groups (see [Workspace Roles](/user-guide/workspace-management/workspace#workspace-roles)), rule roles use the platform's generic action vocabulary rather than rule-specific action names:
>
> - read
> - write
> - delete
