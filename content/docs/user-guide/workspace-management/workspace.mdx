...
- **Clients** – Displays the number of clients within the workspace and their operational status.
...
Below the summary cards, a **bar graph** presents a visual comparison of workspace entities such as members, clients, channels, and groups.  
