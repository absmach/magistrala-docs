...
This action redirects users to the report creation page, where the required details can be provided. There are two main sections: **Configuration** and **Metrics**.
...
|Aggregation Method | The aggregation method, such as Maximum or Minimum| Optional |
