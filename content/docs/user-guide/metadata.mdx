...
Metadata provides additional context and information for entities (clients, channels, groups, and workspaces) in Magistrala. The metadata system supports various value types including text, numbers, booleans, JSON objects, locations, and perimeters.
